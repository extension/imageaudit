...
class CommunityPageStat < ActiveRecord::Base
  ...
  def self.rebuild
    ...
    insert_columns = ['group_id','total_pages','eligible_pages','viewed_pages','viewed_percentiles','image_links','viewed_image_links','hosted_images','viewed_hosted_images','created_at','updated_at']
    insert_values = []
